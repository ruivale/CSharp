/*	Project		:	AnimateTray
 *	File Name	:	TrayForm.cs
 *	Purpose		:	Application main form
...
namespace AnimateTray
{
    ...
    /// <summary>
    ///    Summary description for TrayForm.
    /// </summary>
    public class TrayForm : System.Windows.Forms.Form
    {
        ...
        public TrayForm()
        {
            ...
            {
                MessageBox.Show("Error " + e.Message, "Animate Tray - Error", MessageBoxButtons.AbortRetryIgnore);
                menuItem4.Enabled = false;
        ...
        private void InitializeComponent()
        {
            ...
            m_trayIcon.Icon = new Icon(Application.StartupPath + "\\Icon1.ico");
