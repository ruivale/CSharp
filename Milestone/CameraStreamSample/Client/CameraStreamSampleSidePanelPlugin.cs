...
namespace CameraStreamSample.Client
{
	...
	/// </summary>
	public class CameraStreamSampleSidePanelPlugin : SidePanelPlugin
	{
		/// <summary>
        ...
        //{
        //	return new CameraStreamSampleSidePanelUserControl();
        //}
        ...
        {
            return new CameraStreamSampleSidePanelWpfUserControl();
        }
		...
		{
			get { return CameraStreamSampleDefinition.CameraStreamSampleSidePanel; }
		}
		...
		{
			get { return "CameraStreamSample Side panel"; }
		}
