...
{
    public class CameraStreamSampleSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return CameraStreamSampleDefinition.CameraStreamSampleSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "CameraStreamSample"; } }
        ...
        {
            _userControl = new CameraStreamSampleSettingsPanelControl(this);
            return _userControl;
        }
