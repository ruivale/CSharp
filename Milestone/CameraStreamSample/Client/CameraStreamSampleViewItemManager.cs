...
namespace CameraStreamSample.Client
{
	...
	/// </summary>
	public class CameraStreamSampleViewItemManager : ViewItemManager
	{
		private Guid _someid;
		private string _someName;
		private List<Item> _configItems;

        public CameraStreamSampleViewItemManager(): base("CameraStreamSampleViewItemManager")
        {
		}
		...
		public override void PropertiesLoaded()
		{
			...
			_configItems = Configuration.Instance.GetItemConfigurations(CameraStreamSampleDefinition.CameraStreamSamplePluginId, null, CameraStreamSampleDefinition.CameraStreamSampleKind);
        ...
        //{
        //	return new CameraStreamSampleViewItemUserControl(this);
        //}
        ...
        {
            return new CameraStreamSampleViewItemWpfUserControl(this);
        }
        ...
        //{
        //	return new CameraStreamSamplePropertiesUserControl(this);
        //}
        ...
        {
            return new CameraStreamSamplePropertiesWpfUserControl(this);
        }
