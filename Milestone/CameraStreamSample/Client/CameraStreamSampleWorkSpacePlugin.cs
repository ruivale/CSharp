...
{
    public class CameraStreamSampleWorkSpacePlugin : WorkSpacePlugin
	{
		...
		{
			get { return CameraStreamSampleDefinition.CameraStreamSampleWorkSpacePluginId; }
		}
		...
		public override void Init()
		{
			...
			ViewAndLayoutItem.InsertViewItemPlugin(1, new CameraStreamSampleWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
