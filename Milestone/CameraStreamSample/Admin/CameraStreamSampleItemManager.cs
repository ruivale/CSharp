...
namespace CameraStreamSample.Admin
{
	...
	/// </summary>
	public class CameraStreamSampleItemManager : ItemManager
    {
        private CameraStreamSampleUserControl _userControl;
		private Guid _kind;

		#region Constructors

		public CameraStreamSampleItemManager(Guid kind) : base()
		{
			_kind = kind;
		}
		...
		{
			_userControl = new CameraStreamSampleUserControl();
		...
		{
			return new CameraStreamSampleAddUserControl();
		}
		...
		public override bool ValidateAndSaveUserControl()
		{
			if (CurrentItem != null)
			{
				...
				Configuration.Instance.SaveItemConfiguration(CameraStreamSampleDefinition.CameraStreamSamplePluginId, CurrentItem);
			}
			return true;
		}
		...
		{
			CurrentItem = new Item(suggestedFQID, ((CameraStreamSampleAddUserControl)addUserControl).ItemName);
			Configuration.Instance.SaveItemConfiguration(CameraStreamSampleDefinition.CameraStreamSamplePluginId, CurrentItem);
			return CurrentItem;
		}
		...
		public override void DeleteItem(Item item)
		{
			if (item != null)
			{
				Configuration.Instance.DeleteItemConfiguration(CameraStreamSampleDefinition.CameraStreamSamplePluginId, item);
			}
		...
		public override List<Item> GetItems()
		{
			...
			List<Item> items = Configuration.Instance.GetItemConfigurations(CameraStreamSampleDefinition.CameraStreamSamplePluginId, null, _kind);
			return items;
		}
		...
		{
			List<Item> items = Configuration.Instance.GetItemConfigurations(CameraStreamSampleDefinition.CameraStreamSamplePluginId, parentItem, _kind);
			return items;
		}
		...
		{
			Item item = Configuration.Instance.GetItemConfiguration(CameraStreamSampleDefinition.CameraStreamSamplePluginId, _kind, fqid.ObjectId);
			return item;
		}
