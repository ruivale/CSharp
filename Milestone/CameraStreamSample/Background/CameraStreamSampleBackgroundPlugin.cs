...
namespace CameraStreamSample.Background
{
	/// <summary>
	...
	/// </summary>
	public class CameraStreamSampleBackgroundPlugin : BackgroundPlugin
	{
		...
		{
			get { return CameraStreamSampleDefinition.CameraStreamSampleBackgroundPlugin; }
		}
		...
		{
			get { return "CameraStreamSample BackgroundPlugin"; }
		}
		...
		public override void Init()
		{
			...
			_thread.Name = "CameraStreamSample Background Thread";
			_thread.Start();
		...
		private void Run()
		{
			EnvironmentManager.Instance.Log(false, "CameraStreamSample background thread", "Now starting...", null);
			while (!_stop)
			{
				// Do some work here.
			...
			EnvironmentManager.Instance.Log(false, "CameraStreamSample background thread", "Now stopping...", null);
			_thread = null;
		}
	}
}
