...
{
    /// <summary>
    /// Class to represent a view in the Milestone system.
    /// 
    /// It also allows for quick retrieval of a view's instance from its FQID.
    /// </summary>
    public class View
    {
        ...
        /// <summary>
        /// Get a view instance from its FQID.
        /// </summary>
        /// <param name="fqid"></param>
        public View(FQID fqid, string strName)
        {
            _fqid = fqid;
        ...
        {
            return
                $"View[{strIndent}Name:{this.Name} {strIndent}FQID[" +
