...
{	
	...
	public class EdgeCollection: System.Collections.CollectionBase
	{
		...
		/// </param>
		public virtual void AddRange(IEdge[] items)
		{
		...
		/// </param>
		public virtual void Add(IEdge value)
		{
			this.List.Add(value);
		}
		...
		/// false otherwise.
		/// </returns>
		public virtual bool Contains(IEdge value)
		{
		...
		/// -1 otherwise.
		/// </returns>
		public virtual int IndexOf(IEdge value)
		{
		...
		/// The Edge to insert.
		/// </param>
		public virtual void Insert(int index, IEdge value)
		{
		...
		/// </summary>
		public virtual IEdge this[int index]
		{
			get
			{
		...
		/// </param>
		public virtual void Remove(IEdge value)
		{
