...
namespace QuickGraph.Collections
{
	...
	/// </summary>
	public class FilteredEdgeEnumerable: IEnumerable
	{
		private EdgeCollection m_EdgeCollection;
		...
		/// Base collection
		/// </summary>
		public EdgeCollection BaseCollection
		{
			get
			{
		...
		{
			private EdgeCollection.Enumerator m_Enumerator;
